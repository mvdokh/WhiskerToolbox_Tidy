...
![](../images/tongue0001-1000.gif){fig-align="center" width="760"}
...
Watch the complete keypoint labeling workflow from start to finish:

<video controls preload="metadata" width="100%" style="max-width: 960px; display: block; margin: 0 auto;">
    <source src="../images/keypoint_example.mp4" type="video/mp4">
    Your browser does not support the video tag. You can download the video here:
    <a href="../images/keypoint_example.mp4">keypoint_example.mp4</a>.
</video>
