...
## Assigning a TimeFrame to a New Data Feature

When you create a new feature in Data Manager, you can assign either a
TimeFrame that was loaded from source data or one you created yourself.

1. Open **Modules > Data Manager**.
2. In **Create New Data**, enter the new feature key and data type.
3. In the **TimeFrame** dropdown, select the desired TimeFrame.
4. Click **Create** to register the new feature.

![Assigning a loaded or newly created TimeFrame to a new data feature in the Data Manager.](../images/assign_timeframe.png){fig-align="center"}

This assignment determines how the new feature synchronizes with other
modalities in plots, labeling workflows, and transforms.
